...
<fieldset>
    ...
    echo $this->Form->input('dddfone', array('id' => 'ddd', 'label' => 'DDD Fone:', 'type' => 'numeric', 'maxlength' => 3));
    echo $this->Form->input('fone', array('id' => 'fone', 'label' => 'Telefone:', 'type' => 'text', 'maxlength' => 9));
    echo $this->Form->input('dddcelular', array('id' => 'ddd', 'label' => 'DDD Celular:', 'type' => 'numeric', 'maxlength' => 3));
    ...
    <div id='endereco'>
        ...
        if (!empty($this->request->data['Endereco'][0])) {
            echo $this->Form->input('estado_id', array('id' => 'estadoID', 'type' => 'select', 'options' => $estados, 'value' => $this->request->data['Endereco'][0]['estado_id']));
        ...
        echo $this->Form->input('Endereco.0.observacao', array('id' => 'cep', 'label' => 'Observação do endereço:'));
        ?>
    </div>
</fieldset>
